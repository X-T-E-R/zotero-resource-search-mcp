...
```json
{"name":"academic_search","arguments":{"query":"topology optimization lattice","platform":"wos","maxResults":5,"sortBy":"citations"}}
```
...
```json
{"name":"web_search","arguments":{"query":"latest React 19 features","mode":"docs","max_results":5}}
```
...
```json
{"name":"web_research","arguments":{"query":"impact of AI on drug discovery 2024","scrape_top_n":3}}
```
...
```json
{"name":"resource_lookup","arguments":{"url":"https://example.com/article","formats":["markdown"]}}
```
